        ...
        <Scene key="root">
          ...
          <Scene key='githublogin' component={GithubLogin} title='Github Login' hideNavBar/>
            <Scene key="main" tabs={true} tabBarIconContainerStyle={{  backgroundColor: '#F5FCFF', borderColor: 'black', borderTopWidth: 2, marginTop: 2 }} >
              <Scene key="tab1"  icon={TabIcon} title="inbox" >
                    <Scene initial key='appContainer' component={AppContainer} hideNavBar />
                    <Scene key='pushPayload' component={PushPayload} title='Push Event' hideNavBar={false}/>
